...
export const metadata = {
  ...
  description: 'Privacy Policy for swapnilughade.com',
};
      ...
      <div className="container" style={{ maxWidth: '780px' }}>
        ...
        <div style={{ padding: '36px', background: 'var(--bone-warm)', border: '1px solid var(--line)', borderLeft: '4px solid var(--gold)' }}>
          <p style={{ fontSize: '15px', color: 'var(--ink-soft)', lineHeight: 1.7, marginBottom: 0 }}>
            This policy is currently being updated. The complete privacy and data governance framework will be published here shortly. For immediate inquiries, please reach out via the <Link href="/contact" style={{ color: 'var(--rosewood)', textDecoration: 'underline' }}>contact page</Link>.
          </p>
        </div>
      </div>
    </div>
